...
> {
	...
	constructor(baseTableName: T, SupaStore: SupaStore<D, T>, channel: RealtimeChannel) {
		this.supaStore = SupaStore;
		this.baseTableName = baseTableName;

		this.subscribeSupabase(channel);
	}
	 ...
	 */
	addAllListener<
		Table extends keyof D['public']['Tables'] & string // The main Table
	>(
